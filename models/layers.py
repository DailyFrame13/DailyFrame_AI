...
class ImageLayer:
    ...
    def add_layers(layer_list, background=None):
        ...
        for i in range(0, num_layers):
            ...
            bottom_mask = ImageLayer.get_mask_from_image(bottom_mask)
            top_mask = ImageLayer.get_mask_from_image(ftb_composites[i])
